...
function ui(){
 ...
 else if(o.id==='pluto')$('object-note').innerHTML='Pluto is a dwarf planet, not one of the eight planets. The IAU reclassified it in 2006 because it has not gravitationally cleared its orbital neighbourhood. <a href="https://www.iau.org/IAU/IAU/Astronomy-FAQs/FAQs.aspx" target="_blank" rel="noreferrer">About the classification</a>.';
